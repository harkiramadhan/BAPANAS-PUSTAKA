...
<section class="hero-section py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 hero-text mb-5 text-center text-md-start">
            ...
            <div class="col-md-6">
                <img src="https://andiakmalpasluddin.id/wp-content/uploads/2020/07/kantor-pusat-kementerian-pertanian-1200x600.jpg" alt="Ilustrasi Perpustakaan" class="rounded-5 w-100">
            </div>
        </div>
    </div>
</section>