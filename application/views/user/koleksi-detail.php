        ...
        <div class="row">
            <div class="col-12 col-lg-3 mb-4 mb-lg-0">
                ...
                <?php elseif (is_array($jenis_array) && in_array("1", $jenis_array)) : ?>
                    <?php if($this->session->userdata('is_loggedin')): ?>
                        <a href="<?= site_url('user/koleksi/read/' . md5($buku->id)) ?>" class="btn btn-warning w-100 px-5 py-3 fw-medium shadow-lg" target="__BLANK"><i class="bi bi-bookmark-plus-fill me-2"></i>Baca Online</a>
                    <?php else: ?>
                        <a href="<?= site_url('login') ?>" class="btn btn-warning w-100 px-5 py-3 fw-medium shadow-lg"><i class="bi bi-bookmark-plus-fill me-2"></i>Baca Online</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
