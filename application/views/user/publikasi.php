...
<section class="pt-4 pb-5" style="background: #FFF;">
    <div class="container-xl mb-5">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 fw-normal">Semua Pers Halaman <span class="fw-bold text-primary fst-italic">' 1 '</span> dari 10</h4>
        </div>
            ...
            <div class="col-12 col-md-3 col-lg-3 mb-3">
                <a href="<?= site_url('publikasi/detail') ?>" style="text-decoration: none;">
                    ...
                    <div class="px-2">
                        ...
                        <h5 class="fw-semibold mb-1 mt-2 text-black">The Architecture Of Love.</h5>                    
