...
<div class="page-content"> 
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form method="POST" action="<?= site_url('admin/publikasi/') ?>" class="form form-horizontal" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <select class="form-select" name="id_jenis[]">
                                            <option value="">Publikasi Pers</option>
                                            <option value="">Media NVA</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
